...
class WeatherAPI:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                weather_data = {
                    ...
                    'wind': {
                        'speed': round(current['wind_speed_10m'] / 3.6, 1)  # Convert km/h to m/s
                    },
                    'weather': [
                        {'main': self.get_weather_description(current['weather_code']), 
                         'description': self.get_weather_description(current['weather_code']).lower()}
                    ],
                    'success': True
                }
    ...
    def generate_demo_data(self):
        ...
        demo_data = {
            ...
            'weather': [
                {'main': 'Demo', 'description': 'demo weather data'}
            ],
            'success': True,
            'is_demo': True
        }
