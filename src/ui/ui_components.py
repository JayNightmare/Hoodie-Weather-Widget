...
class UIComponents:
    ...
    @classmethod
    def create_styled_button(cls, parent, text, command=None, color='accent_blue',
                           font='small', width=None, height=None, style="modern", **kwargs):
    ...
    @classmethod
    def create_styled_label(cls, parent, text="", font='normal', color='text_primary',
    ...
    def create_styled_entry(cls, parent, font='normal', **kwargs):
        ...
        if TTKBOOTSTRAP_AVAILABLE:
            ...
            # Add focus effects
            def on_focus_in(e):
                entry.config(highlightcolor=cls.COLORS['accent_blue'], highlightthickness=2)
            def on_focus_out(e):
    ...
    def draw_progress_bar(cls, canvas, level):
        ...
        colors = [cls.COLORS['progress_green'],
        ...
        for i in range(3):
            ...
            if i < 2:  # Don't draw separator after last section
                canvas.create_line(
                    x2, 1, x2, canvas_height-1,
                    fill=cls.COLORS['bg_primary'], width=1
                )
        ...
        canvas.create_oval(
            indicator_x-6, 2, indicator_x+6, canvas_height-2,
        ...
        # Indicator highlight
        canvas.create_oval(
            indicator_x-3, 5, indicator_x+1, 9,
            fill='#ffffff', outline=''
        )
    
    @classmethod
    def setup_window_style(cls, window, title="Hoodie Weather Widget", size="800x600",
    ...
    def create_enhanced_settings_popup(cls, parent, weather_widget):
        ...
        current_location = getattr(weather_widget, 'weather_data', {}).get('full_location', 'Unknown')
        current_coords = getattr(weather_widget, 'weather_data', {}).get('coordinates', 'Unknown')
